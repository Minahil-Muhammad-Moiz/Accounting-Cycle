...
class splashScreen():
    ...
    def splash(self):
        ...
        self.image = self.image.resize((640,630), Image.Resampling.LANCZOS)
        ...
        canvas.create_text(180,160, text=' Course Instructor:\n\tSir Farhan Ahmed', font=("Times 10 bold",18),fill = 'white')
        canvas.create_text(470,145, text='BSSE-22', font=("Times 10 bold",18),fill = 'white')
